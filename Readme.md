...
```
               Parent
  151,301 op/s » Append 1 new node to an empty parent
   75,399 op/s » Append 2 new nodes to an empty parent
   52,227 op/s » Append 3 new nodes to an empty parent
   71,286 op/s » Append 1 attached node to an empty parent
   37,957 op/s » Append 2 attached nodes to an empty parent
   24,412 op/s » Append 3 attached nodes to an empty parent
      709 op/s » Append 100 attached nodes to an empty parent
  138,337 op/s » Prepend 1 new node to an empty parent
   78,844 op/s » Prepend 2 new nodes to an empty parent
   51,852 op/s » Prepend 3 new nodes to an empty parent
   72,788 op/s » Prepend 1 attached node to an empty parent
   37,989 op/s » Prepend 2 attached nodes to an empty parent
   26,276 op/s » Prepend 3 attached nodes to an empty parent
      702 op/s » Prepend 100 attached nodes to an empty parent

               Child
   65,507 op/s » Insert 1 new node after an only child
   45,142 op/s » Insert 2 new nodes after an only child
   35,541 op/s » Insert 3 new nodes after an only child
   44,671 op/s » Insert 1 attached node after an only child
   28,038 op/s » Insert 2 attached nodes after an only child
   20,542 op/s » Insert 3 attached nodes after an only child
      657 op/s » Insert 100 attached nodes after a first child
   68,555 op/s » Insert 1 new node before a first child
   52,408 op/s » Insert 2 new nodes before a first child
   41,970 op/s » Insert 3 new nodes before a first child
   49,628 op/s » Insert 1 attached node before a first child
   31,252 op/s » Insert 2 attached nodes before a first child
   22,712 op/s » Insert 3 attached nodes before a first child
